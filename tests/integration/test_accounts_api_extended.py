...
@pytest.mark.asyncio
async def test_accounts_list_reports_weekly_exhaustion_despite_rate_limit_and_credits(async_client, db_setup):
    ...
    assert accounts["acc_credit_rate_limited"]["status"] == "quota_exceeded"
