...
- [x] 1.5 Add focused regressions for no-waiter expiry, send-time anchoring, leading telemetry, response-lifecycle deadline resets, downstream-visible suppression, terminal settlement, and account neutrality.
